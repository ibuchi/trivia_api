...
def create_app(test_config=None):
    ...
    def search_questions():
        ...
        input = request_body.get('searchTerm', None)
        search = '%{}%'.format(input)
        question_search = Question.query.filter(Question.question.ilike(search)).all()
        selection =paginate_questions(request, question_search)
    ...
    def questions_by_category(category_id):
        try:
            ...
            paginate_question = paginate_questions(request, questions)
            ...
            return jsonify(
                {
                    ...
                    "totalQuestions": len(paginate_question),
                    "currentCategory": "History",
                }
            )
